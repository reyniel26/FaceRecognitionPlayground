...
if __name__ == "__main__":
    ...
    model_path = "models"
    model = os.path.join(model_path,"trained_knn_model.clf")
    classifier = train("train_dir", model_save_path=model , n_neighbors=2)
    ...
    for image_file in os.listdir("test_dir"):
        ...
        predictions = predict(full_file_path, model_path=model)
